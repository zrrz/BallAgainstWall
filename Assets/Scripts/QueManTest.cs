/*
 * This is something i'm using to fiddle with the QueueManager without ruining the working build.
 * -Eric
*/
...
public class QueManTest : MonoBehaviour {
	...
	void MoveQueueForward( Waypoint wp ) {
		...
		if( wp.m_occupant != null ) {
			...
			FaceNextWaypoint( wp.m_occupant.transform, m_tempWp );
